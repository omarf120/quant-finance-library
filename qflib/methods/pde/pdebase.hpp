...
#ifndef QF_PDEBASE_HPP
#define QF_PDEBASE_HPP
...
public:
  ...
  PdeBase(SPtrProduct product,
    ...
    std::vector<SPtrVolatilityTermStructure> const & volTermStructs)
    : spprod_(product), spdiscyc_(discountYieldCurve), spots_(spots),
    spaccrycs_(accrualYieldCurves), divyields_(divyields), vols_(volTermStructs)
  {
